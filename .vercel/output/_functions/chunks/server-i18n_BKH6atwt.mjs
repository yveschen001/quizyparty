...
async function loadServerI18n(lang, ns = ["common"]) {
  ...
  if (!serverInstance) {
    ...
    serverInstance.use(
      resourcesToBackend(async (lng, nspace) => {
        ...
        try {
          const mod = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"./locales/de/common.json": () => import('./common_CmJepd6_.mjs'),"./locales/en/common.json": () => import('./common_DxST0s3V.mjs'),"./locales/fr/common.json": () => import('./common_9eoi48sM.mjs'),"./locales/ja/common.json": () => import('./common_BLZEE73d.mjs'),"./locales/ko/common.json": () => import('./common_Xy_V-6uo.mjs'),"./locales/zh-hans/common.json": () => import('./common_DOJB6Y_J.mjs'),"./locales/zh-hant/common.json": () => import('./common_D95SI2bO.mjs')})), `./locales/${lng}/${nspace}.json`, 4);
  ...
  if (currentResources) {
    ...
    try {
      const mod = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"./locales/de/common.json": () => import('./common_CmJepd6_.mjs'),"./locales/en/common.json": () => import('./common_DxST0s3V.mjs'),"./locales/fr/common.json": () => import('./common_9eoi48sM.mjs'),"./locales/ja/common.json": () => import('./common_BLZEE73d.mjs'),"./locales/ko/common.json": () => import('./common_Xy_V-6uo.mjs'),"./locales/zh-hans/common.json": () => import('./common_DOJB6Y_J.mjs'),"./locales/zh-hant/common.json": () => import('./common_D95SI2bO.mjs')})), `./locales/${lang}/common.json`, 4);
      const data = mod.default || mod;
      if (typeof data === "object" && data !== null) {
