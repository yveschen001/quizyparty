...
const $$Created = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["<html", '> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">', "", "</head> <body", '> <a href="#main" class="sr-only">', "</a> ", ' <main id="main"', '> <div id="created-controls" class="mb-3" style="position:sticky;top:0;z-index:5;background:var(--surface,#fff)"></div> <div id="created-pager-top" class="mb-2"></div> <nav', ' class="caption breadcrumb"> <a', ' class="caption"', ">", '</a> <span aria-hidden="true">/</span> <span class="caption">', '</span> </nav> <div class="flex-between"> <h1 class="h1 no-margin">', "</h1> <a", "", ">", '</a> </div> <div id="created-tabs" role="tablist"', ' class="tab-row"> <button id="created-tab-published"', ' role="tab" data-status="published" type="button" aria-selected="true" aria-controls="created-list" tabindex="0"> <span>', '</span> <span class="badge" data-count-badge="published">0</span> </button> <button id="created-tab-draft"', ' role="tab" data-status="draft" type="button" aria-selected="false" aria-controls="created-list" tabindex="-1"> <span>', '</span> <span class="badge" data-count-badge="draft">0</span> </button> </div> <div id="created-message" class="status-text" role="status" aria-live="polite"></div> ', " ", " ", ' <div id="created-list" role="tabpanel" aria-labelledby="created-tab-published"', `></div> <div id="created-pagination" class="flex-between is-hidden"></div> <div id="created-pager-bottom" class="mt-3"></div> </main> <script type="module" src="/js/i18n.js"></script> <script src="/js/room-card-template.js"></script> <script src="/js/qp-cache.js"></script> <script src="/js/rooms-filters.js"></script> <script src="/js/rooms-pagination.js"></script> <script src="/js/room-templates.js"></script> <script type="module">
      ;(async function () {
        ...
        ;(function initControls(){
          try {
            ...
            if (window.RoomsPager) {
              window.__qpRenderCreatedPager = function(total) {
                try {
                  window.RoomsPager.renderControls(document.getElementById('created-pager-top'), total)
                  window.RoomsPager.renderControls(document.getElementById('created-pager-bottom'), total)
                } catch (e) {}
              }
            }
          } catch (e) {}
...
multiple actions, please send them in separate calls.)`], ["<html", '> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">', "", "</head> <body", '> <a href="#main" class="sr-only">', "</a> ", ' <main id="main"', '> <div id="created-controls" class="mb-3" style="position:sticky;top:0;z-index:5;background:var(--surface,#fff)"></div> <div id="created-pager-top" class="mb-2"></div> <nav', ' class="caption breadcrumb"> <a', ' class="caption"', ">", '</a> <span aria-hidden="true">/</span> <span class="caption">', '</span> </nav> <div class="flex-between"> <h1 class="h1 no-margin">', "</h1> <a", "", ">", '</a> </div> <div id="created-tabs" role="tablist"', ' class="tab-row"> <button id="created-tab-published"', ' role="tab" data-status="published" type="button" aria-selected="true" aria-controls="created-list" tabindex="0"> <span>', '</span> <span class="badge" data-count-badge="published">0</span> </button> <button id="created-tab-draft"', ' role="tab" data-status="draft" type="button" aria-selected="false" aria-controls="created-list" tabindex="-1"> <span>', '</span> <span class="badge" data-count-badge="draft">0</span> </button> </div> <div id="created-message" class="status-text" role="status" aria-live="polite"></div> ', " ", " ", ' <div id="created-list" role="tabpanel" aria-labelledby="created-tab-published"', `></div> <div id="created-pagination" class="flex-between is-hidden"></div> <div id="created-pager-bottom" class="mt-3"></div> </main> <script type="module" src="/js/i18n.js"></script> <script src="/js/room-card-template.js"></script> <script src="/js/qp-cache.js"></script> <script src="/js/rooms-filters.js"></script> <script src="/js/rooms-pagination.js"></script> <script src="/js/room-templates.js"></script> <script type="module">
      ;(async function () {
        await import('/js/i18n.js')
        const { setupRoomsManager } = await import('/js/rooms-manager.js')
        const lang = document.documentElement.getAttribute('lang') || 'en'
